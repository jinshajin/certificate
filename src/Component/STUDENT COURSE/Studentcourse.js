...
import { allstudentcourseApi, deletestudentcourseApi } from '../../Store/Students API/useApi';
...
<div style={{display:'flex'}}>
                            <div >
                                < Button style={{backgroundColor:'blue', border:'none',width:'60px',height:'20px' ,fontSize:'10px'}}>View</Button>
                            </div>
                            <div style={{paddingLeft:'15px'}}>
                                <Button     onClick={()=> {deleteCourse(item?.id)}} style={{backgroundColor:'red',border:'none',width:'60px',height:'20px',fontSize:'10px'}}>Delete</Button>
